    ...
    public class StatusManager
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            for (int i = 0; i < Lives; i++)
            {
                ...
                spriteBatch.Draw(lifeTexture, new Vector2(xPosition, 10), new Rectangle(0, 0, lifeTexture.Width / 2, lifeTexture.Height / 2), Color.White, 0.0f, Vector2.Zero, scale, SpriteEffects.None, 0.0f);
            }
        ...
        private void DrawScore(SpriteBatch spriteBatch)
        {
            ...
            var scoreX = bounds.Width - scoreDimensions.X - 5;
            var scoreY = 5;
